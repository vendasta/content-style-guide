...
The way we write, review, and publish legal content is different than how we do many other kinds of writing at Vendasta. The most important difference is that all legal content either starts with or passes through the legal team.

But that doesn't mean legal content has to be difficult to read. We try to present our legal information in the most pleasant way possible. Our goals for Vendasta's legal content are:
...
We keep these in one place on our [legal page](http://Vendasta.com/legal/):

* [Terms of use](http://Vendasta.com/legal/terms/)
* [Acceptable use policy](http://Vendasta.com/legal/acceptable_use/)
* [Privacy policy](http://Vendasta.com/legal/privacy/)
* [API use policy](http://Vendasta.com/legal/api_use/)
* [Copyright policy](http://Vendasta.com/legal/copyright/)

These policies apply to all of Vendasta’s users. The legal and communication teams work together to make them as transparent and easy to read as possible. When someone signs up to use Vendasta, they must agree to all of those terms.
...
- [Terms of Use and anti-spam requirements](http://kb.Vendasta.com/accounts/compliance-tips/terms-of-use-and-anti-spam-requirements-for-campaigns)
- [About the Canada anti-spam law](http://kb.Vendasta.com/accounts/compliance-tips/about-the-canada-anti-spam-law-casl)
- [Stay compliant with CASL](http://kb.Vendasta.com/lists/managing-subscribers/stay-compliant-with-casl)
...
- Vendasta is owned and operated by The Rocket Science Group, LLC d/b/a Vendasta, a Georgia limited liability corporation (“Vendasta,” “we,” or “us”). As a user of the Service or a representative of an entity that’s a user of the Service, you're a “Member” according to this agreement (or “you”).
...
While we want to inform our users about legal issues related to their use of Vendasta, we can’t offer them legal advice. Sometimes it’s a fine line. The legal department will check for this in their content review.
